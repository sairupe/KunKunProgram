...
public class 下半年 {
    ...
    private static final String SAVE_PATH = "C:\\Users\\Administrator\\Desktop\\sda\\2017下半年";
    private static final String READ_PATH = "C:\\Users\\Administrator\\Desktop\\sda\\2017下半年";
    private static final int HEJI_CELL_INDEX = 4;
    private static final int FILENAME_CELL_INDEX = 5;
    private static int saveFileRowIndex = 0;

    public static void main(String[] args) {
        File saveFile = new File(SAVE_PATH + "//下半年.xlsx");
        if (saveFile.exists()) {
            saveFile.delete();
        }
        ...
        try {
            ...
            Sheet toSaveSheet = toSave.createSheet("下半年");
